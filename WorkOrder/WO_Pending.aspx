<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="WO_Pending.aspx.cs" Inherits="TBOffice.WorkOrder.WO_Pending" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="header-table">
        ...
        <tr class="header-row">
            <td>
                <asp:Label ID="Label3" runat="server" Text="W/O Pending:" CssClass="header-label"></asp:Label>
                ...
                <asp:DropDownList ID="ddlCategory" runat="server" AppendDataBoundItems="true" 
                    DataSourceID="dsCategory" DataTextField="ShortDesc" DataValueField="CategoryId" AutoPostBack="true">
                ...
                <asp:DropDownList ID="ddlAssignedUserId" runat="server" AutoPostBack="true">
                    ...
                    <asp:ListItem Text="Bob Emslie" Value="72"></asp:ListItem>
                    <asp:ListItem Text="Darren Reeves" Value="45"></asp:ListItem>
                    <asp:ListItem Text="Dean Peters" Value="11"></asp:ListItem>
                    <asp:ListItem Text="Rick Noll" Value="43"></asp:ListItem>
                    <asp:ListItem Text="Rosa Cuellar" Value="73"></asp:ListItem>
                    <asp:ListItem Text="Other" Value="71"></asp:ListItem>
                </asp:DropDownList>--%>
            ...
            <td class="grid1-cell">
                <asp:GridView ID="gridWO" runat="server" DataSourceID="dsWO" OnRowDataBound="gridWO_RowDataBound" OnSelectedIndexChanged="gridWO_SelectedIndexChanged"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="CategoryDesc" HeaderText="Category" ItemStyle-HorizontalAlign="Center" SortExpression="CategoryDesc" ItemStyle-Width="80px"></asp:BoundField>
                        <asp:BoundField DataField="LocationDesc" HeaderText="Location" ItemStyle-HorizontalAlign="Center" SortExpression="LocationDesc" ItemStyle-Width="80px"></asp:BoundField>
                        <asp:BoundField DataField="PriorityDesc" HeaderText="Priority" ItemStyle-HorizontalAlign="Center" SortExpression="PriorityDesc" ItemStyle-Width="80px"></asp:BoundField>
                        ...
                        <asp:BoundField DataField="RequestBy" HeaderText="Request By" ItemStyle-HorizontalAlign="Center" SortExpression="RequestBy" ItemStyle-Width="80px"></asp:BoundField>
                        ...
                        <asp:BoundField DataField="CostEstimate" HeaderText="$$ Est." ItemStyle-CssClass="gpad" ItemStyle-HorizontalAlign="Right" SortExpression="CostEstimate" ItemStyle-Width="80px" DataFormatString="{0:c0}" ></asp:BoundField>
    ...
    <asp:SqlDataSource ID="dsEEList" runat="server" ConnectionString="<%$ ConnectionStrings:TBBF %>" 
        SelectCommand="get_FacilityAdminList" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="dsWO" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="get_tblWorkOrders_Pending" SelectCommandType="StoredProcedure">
        <SelectParameters>
