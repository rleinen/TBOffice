<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="WO_Completed.aspx.cs" Inherits="TBOffice.WorkOrder.WO_Completed" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="header-table">
        ...
        <tr class="header-row">
            <td>
                <asp:Label ID="Label3" runat="server" Text="W/O Completed:" CssClass="header-label"></asp:Label>
            ...
            <td class="grid1-cell">
                <asp:GridView ID="gridWO" runat="server" DataSourceID="dsWO" OnRowDataBound="gridWO_RowDataBound" OnSelectedIndexChanged="gridWO_SelectedIndexChanged"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="CompletedName" HeaderText="Completed By" SortExpression="CompletedName" ItemStyle-Width="70px"></asp:BoundField>
                        ...
                        <asp:BoundField DataField="CompletedDate" HeaderText="Completed" ItemStyle-HorizontalAlign="Center" SortExpression="CompletedDate" DataFormatString="{0:MM/dd/yy}" ItemStyle-Width="80px"></asp:BoundField>
    ...
    <asp:SqlDataSource ID="dsWO" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="get_tblWorkOrders_Completed" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlAssignedUserId" PropertyName="SelectedValue" Name="CompletedUserId" Type="Int32"></asp:ControlParameter>
