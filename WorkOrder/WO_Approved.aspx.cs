...
{
    public partial class WO_Approved : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            dsEEList.SelectParameters["UserId"].DefaultValue = SessionMgr.User.UserID.ToString();
            this.Title = "Pending WO List";
            if (MyUser.IsFacilityAdmin() == false && MyUser.IsFacilityTeam() == false)
            {
        ...
        protected void ddlActionUser_DataBound(object sender, EventArgs e)
        {
            ...
            {
                ddlActionUser.Items.FindByValue("16").Selected = true;
            }
