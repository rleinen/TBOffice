<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="WOByCategory.aspx.cs" Inherits="TBOffice.WorkOrder.WOByCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="header-table">
        ...
        <tr class="header-row">
            <td>
                <asp:Label ID="Label3" runat="server" Text="W/O By Category:" CssClass="header-label"></asp:Label>
                <Spc:SpacerImage ID="SpacerImage1" runat="server" Width="5px" />
                <asp:DropDownList ID="ddlCategory" runat="server" DataSourceID="dsCategory" DataTextField="ShortDesc" DataValueField="CategoryId" AutoPostBack="true">
                </asp:DropDownList>
                ...
                <Spc:SpacerImage ID="SpacerImage6" runat="server" Width="70px" />
            ...
            <td class="grid1-cell">
                <asp:GridView ID="gridWO" runat="server" DataSourceID="dsWO" OnRowDataBound="gridWO_RowDataBound" OnSelectedIndexChanged="gridWO_SelectedIndexChanged"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="StatusDesc" HeaderText="Status" ItemStyle-HorizontalAlign="Center" SortExpression="StatusDesc" ItemStyle-Width="70px"></asp:BoundField>
    ...
    <asp:SqlDataSource ID="dsCategory" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="SELECT [CategoryId], [ShortDesc] FROM [tblWOCategory] ORDER BY [SeqNum]"></asp:SqlDataSource>
    <asp:SqlDataSource ID="dsWO" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="get_tblWorkOrders_by_Category" SelectCommandType="StoredProcedure">
        <SelectParameters>
