<%@ Page Title="CBC Income" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="CBCIncome.aspx.cs" Inherits="TBOffice.Finances.CBCIncome" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width: 100%;" class="header-table">
        <tr class="header-row">
            <td colspan="2">
                <asp:Label ID="Label3" runat="server" Text="CBC Income" CssClass="header-label"></asp:Label>
        ...
        <tr>
            <td style="width:600px;vertical-align:top; text-align:left;">
                ...
                <td style="vertical-align:top; text-align:left; padding-top:5px;" >
                    <div style="height:200px; overflow-y:auto; border:solid 1px #000000;">
            ...
            <td style="vertical-align:top; text-align:left; padding-left:5px;">
                ...
                <asp:GridView ID="gvIncExpSummary" runat="server" AutoGenerateColumns="False" DataSourceID="dsIncExpSummary" Width="600" 
                    ...
                    <Columns>
                        <asp:BoundField DataField="General Fund" HeaderText="CBC General Fund" ReadOnly="True" SortExpression="General Fund"></asp:BoundField>
    ...
    <asp:SqlDataSource ID="dsIncomeDepts" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="get_CBC_IncomeDept_BudgetVSActual" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlFiscalYear" PropertyName="SelectedValue" Name="FiscalYear" Type="Int32"></asp:ControlParameter>
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="dsIncomeAccts" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="get_IncomeSubDept_BudgetVSActual" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlFiscalYear" PropertyName="SelectedValue" Name="FiscalYear" Type="Int32"></asp:ControlParameter>
