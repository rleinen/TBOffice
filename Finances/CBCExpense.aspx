<%@ Page Title="CBC Expenses" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="CBCExpense.aspx.cs" Inherits="TBOffice.Finances.CBCExpense" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width: 100%;" class="header-table">
        <tr class="header-row">
            <td colspan="2">
                <asp:Label ID="Label3" runat="server" Text="CBC Expenses" CssClass="header-label"></asp:Label>
        ...
        <tr>
            <td style="width:600px;vertical-align:top; text-align:left;">
                ...
                <tr><td>
                    <div style="height:217px; border:solid 1px #000000;">
                ...
                <td style="vertical-align:top; text-align:left; padding-top:5px;" >
                    <div style="height:277px; overflow-y:auto; border:solid 1px #000000;">
                    ...
                    <asp:GridView ID="gvExpenseSubDepts" runat="server" AutoGenerateColumns="False" DataKeyNames="AcctId" DataSourceID="dsExpenseSubDepts" 
                        BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" GridLines="Both"
                        Font-Names="Arial" Font-Size="Small" ShowFooter="true" OnRowDataBound="gvExpenseSubDepts_RowDataBound" OnSelectedIndexChanged="gvExpenseSubDepts_SelectedIndexChanged" >
                        <Columns>
    ...
    <asp:SqlDataSource ID="dsExpenseDepts" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="get_CBC_ExpenseDept_BudgetVSActual" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlFiscalYear" PropertyName="SelectedValue" Name="FiscalYear" Type="Int32"></asp:ControlParameter>
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="dsExpenseSubDepts" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="get_ExpenseSubDept_BudgetVSActual" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlFiscalYear" PropertyName="SelectedValue" Name="FiscalYear" Type="Int32"></asp:ControlParameter>
    ...
    <asp:SqlDataSource ID="dsAcctTrans" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="get_Acct_Trans_By_FY" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlFiscalYear" PropertyName="SelectedValue" Name="FiscalYear" Type="Int32"></asp:ControlParameter>
            <asp:ControlParameter ControlID="gvExpenseSubDepts" PropertyName="SelectedValue" Name="AcctId" Type="Int32"></asp:ControlParameter>
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="dsMonthlySummary" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="get_Expense_Acct_BudgetVSActual_Monthly_By_FY" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="gvExpenseSubDepts" PropertyName="SelectedValue" Name="AcctId" Type="Int32"></asp:ControlParameter>
            <asp:ControlParameter ControlID="ddlFiscalYear" PropertyName="SelectedValue" Name="FiscalYear" Type="Int32"></asp:ControlParameter>
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="dsIncExpSummary" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="get_CBC_IncomeExpenseSummary_BudgetVSActual" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlFiscalYear" PropertyName="SelectedValue" Name="FiscalYear" Type="Int32"></asp:ControlParameter>
        </SelectParameters>
    </asp:SqlDataSource>
