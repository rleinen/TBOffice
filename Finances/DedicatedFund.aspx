<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DedicatedFund.aspx.cs" Inherits="TBOffice.Finances.DedicatedFund" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width: 100%;" class="header-table">
        <tr class="header-row">
            <td colspan="2">
                <asp:Label ID="Label3" runat="server" Text="Dedicated Fund Accounts" CssClass="header-label"></asp:Label>
        ...
        <tr>
            <td style="width:565px;vertical-align:top; text-align:left;">
                ...
                <tr><td>
                    <asp:GridView ID="gvDFDeptSummary" runat="server" AutoGenerateColumns="False" DataKeyNames="DeptAcctId" DataSourceID="dsDFDeptSummary" 
                        BackColor="White" BorderColor="#000000" BorderStyle="None" BorderWidth="1px" CellPadding="4" GridLines="Both"
                    Font-Names='"Courier New",Courier,monospace' Font-Size="Small" ShowFooter="true" OnRowDataBound="gvDFDeptSummary_RowDataBound" >
                        <Columns>
                            <asp:CommandField ShowSelectButton="True" ItemStyle-Width="250" FooterStyle-HorizontalAlign="Right" HeaderText="Departments"></asp:CommandField>
                            ...
                            <asp:BoundField DataField="DeptDesc" HeaderText="Departments" SortExpression="DeptDesc" Visible="false"></asp:BoundField>
            ...
            <td style="vertical-align:top; text-align:left; padding-left:5px;">
                <div style="height:650px; width:800px; overflow-y:auto; border:solid 1px #000000;">
    ...
    <asp:SqlDataSource ID="dsDFDeptSummary" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="get_DF_DeptAcct_Summary" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlFiscalYear" PropertyName="SelectedValue" Name="FiscalYear" Type="Int32"></asp:ControlParameter>
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="dsDFAcctSummary" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="get_DF_Acct_Summary" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlFiscalYear" PropertyName="SelectedValue" Name="FiscalYear" Type="Int32"></asp:ControlParameter>
            <asp:ControlParameter ControlID="gvDFDeptSummary" PropertyName="SelectedValue" Name="DeptAcctId" Type="Int32"></asp:ControlParameter>
        </SelectParameters>
    </asp:SqlDataSource>
