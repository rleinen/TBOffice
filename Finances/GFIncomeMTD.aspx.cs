...
{
    public partial class GFIncomeMTD : System.Web.UI.Page
    {
        ...
        protected void BudgetForm_BudgetUpdated(object sender, EventArgs e)
        {
            ...
            dsIncomeAccts.Select(DataSourceSelectArguments.Empty);
            gvIncomeAccts.DataBind();

            dsIncomeDepts.Select(DataSourceSelectArguments.Empty);
            gvIncomeDepts.DataBind();
        ...
        protected void gvIncomeAccts_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            BudgetForm.LoadBudget(Convert.ToInt32(ddlFiscalYear.SelectedValue), Convert.ToInt32(gvIncomeAccts.SelectedDataKey.Value));
        }
    }
}