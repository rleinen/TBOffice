<%@ Page Title="Ministry Dedicated Accounts" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="MinistryDedicatedAccounts.aspx.cs" Inherits="TBOffice.Finances.MinistryDedicatedAccounts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width: 100%;" class="header-table">
        <tr class="header-row">
            <td colspan="2">
                <asp:Label ID="Label3" runat="server" Text="Ministry Dedicated Accounts" CssClass="header-label"></asp:Label>
        ...
        <tr>
            <td style="width:530px;vertical-align:top; text-align:left;padding-top:5px;">
                <table style="width: 100%;" class="column1-table">
                <tr>
                <td style="vertical-align:top; text-align:left; padding-top:5px;" >
                    <asp:GridView ID="gvUserDedAccounts" runat="server" AutoGenerateColumns="False" DataKeyNames="AcctId" DataSourceID="dsUserDedAccounts" 
                        BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" GridLines="Both"
                        Font-Names="Arial" Font-Size="Small" ShowFooter="true"  OnRowDataBound="gvUserDedAccounts_RowDataBound">
                        <Columns>
                            <asp:CommandField ShowSelectButton="True" HeaderText="Account Name" ControlStyle-Font-Names="Arial" ItemStyle-Width="250" FooterStyle-HorizontalAlign="Right"></asp:CommandField>
                            ...
                            <asp:BoundField DataField="BegBalAmt" HeaderText="Beg. Bal." DataFormatString="{0:c0}" 
                                ItemStyle-Width="75" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right"></asp:BoundField>
                            <asp:BoundField DataField="ChangeAmt" HeaderText="Change Amt" ReadOnly="True" DataFormatString="{0:c0}" 
                                ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right"></asp:BoundField>
                            <asp:BoundField DataField="NewBalance" HeaderText="New Balance" ReadOnly="True" ItemStyle-Width="75" DataFormatString="{0:c0}" 
                                ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right"></asp:BoundField>
                        </Columns>
    ...
    <asp:SqlDataSource ID="dsAcctTrans" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="get_Acct_Trans_By_FY" SelectCommandType="StoredProcedure">
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="gvUserDedAccounts" PropertyName="SelectedValue" Name="AcctId" Type="Int32"></asp:ControlParameter>
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="dsUserDedAccounts" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="get_User_DedicatedSummary" SelectCommandType="StoredProcedure">
        <SelectParameters>
