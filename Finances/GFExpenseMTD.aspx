<%@ Page Title="GF Expense MTD" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="GFExpenseMTD.aspx.cs" 
    Inherits="TBOffice.Finances.GFExpenseMTD" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width: 100%;" class="header-table">
        <tr class="header-row">
            <td colspan="2">
                ...
                <asp:Label ID="Label2" runat="server" Text="Choose Month: " CssClass="label"></asp:Label>
                <cc1:OboutDropDownList ID="ddlFiscalMonth" runat="server" AutoPostBack="True" DataTextField="ShortDesc" DataValueField="MonthId"
                    FolderStyle="styles//dropdownlist/black_glass/OboutDropDownList" Width="200px" ControlsToDisable="" ControlsToEnable="" DataSourceID="dsFiscalMonth" 
                    DisablingValues="" EnablingValues="" MenuWidth="200px">
                </cc1:OboutDropDownList>
            </td>
        </tr>
    ...
    <asp:SqlDataSource runat="server" ID="dsFiscalMonth" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="SELECT [MonthId], [ShortDesc] FROM [t_acct_fiscal_month] ORDER BY [MonthId] DESC"></asp:SqlDataSource>
    <asp:SqlDataSource ID="dsExpenseDepts" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="get_GF_ExpenseDept_BudgetVSActual_MTD" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlFiscalMonth" PropertyName="SelectedValue" Name="MonthId" Type="Int32"></asp:ControlParameter>
        </SelectParameters>
    </asp:SqlDataSource>

    <asp:SqlDataSource ID="dsExpenseSubDepts" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="get_GF_ExpenseSubDept_BudgetVSActual_MTD" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlFiscalMonth" PropertyName="SelectedValue" Name="MonthId" Type="Int32"></asp:ControlParameter>
    ...
    <asp:SqlDataSource ID="dsExpenseAccts" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="get_GF_ExpenseAcct_BudgetVSActual_MTD" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlFiscalMonth" PropertyName="SelectedValue" Name="MonthId" Type="Int32"></asp:ControlParameter>
    ...
    <asp:SqlDataSource ID="dsAcctTrans" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="get_Acct_Trans_By_FYM" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlFiscalMonth" PropertyName="SelectedValue" Name="MonthId" Type="Int32"></asp:ControlParameter>
    ...
    <asp:SqlDataSource ID="dsIncExpSummary" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="get_GF_IncomeExpenseSummary_BudgetVSActual_MTD" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlFiscalMonth" PropertyName="SelectedValue" Name="MonthId" Type="Int32"></asp:ControlParameter>
        </SelectParameters>
    </asp:SqlDataSource>
