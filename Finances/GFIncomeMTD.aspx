<%@ Page Title="GF Income" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="GFIncomeMTD.aspx.cs" Inherits="TBOffice.Finances.GFIncomeMTD" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="dsIncomeDepts" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="get_GF_IncomeDept_BudgetVSActual_MTD" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlFiscalMonth" PropertyName="SelectedValue" Name="MonthId" Type="Int32"></asp:ControlParameter>
        </SelectParameters>
    </asp:SqlDataSource>
    
    <asp:SqlDataSource ID="dsIncomeAccts" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="get_GF_IncomeSubDept_BudgetVSActual_MTD" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlFiscalMonth" PropertyName="SelectedValue" Name="MonthId" Type="Int32"></asp:ControlParameter>
