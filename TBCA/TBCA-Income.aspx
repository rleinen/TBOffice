<%@ Page Title="TBCA Income" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="TBCA-Income.aspx.cs" Inherits="TBOffice.TBCA.TBCA_Income" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style type="text/css">
        ...
        .header-row {font-family:Tahoma; background-color:#d6dbe9}
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width: 100%;" class="header-table">
        <tr class="header-row">
            <td colspan="2">
                <asp:Label ID="Label3" runat="server" Text="TBCA Income" CssClass="header-label"></asp:Label>

                <asp:Label ID="Label2" runat="server" Text="Fund: " CssClass="label"></asp:Label>
                <cc1:OboutDropDownList ID="ddlFund" runat="server" AutoPostBack="True" DataTextField="ShortDesc" DataValueField="FundId"
                    FolderStyle="styles//dropdownlist/black_glass/OboutDropDownList" Width="200px" ControlsToDisable="" ControlsToEnable="" DataSourceID="dsFundList" 
                    DisablingValues="" EnablingValues="" MenuWidth="200px" OnSelectedIndexChanged="ddlFund_SelectedIndexChanged">
                ...
                <cc1:OboutDropDownList ID="ddlFiscalYear" runat="server" AutoPostBack="True" DataTextField="ShortDesc" DataValueField="FiscalYear"
                    FolderStyle="styles//dropdownlist/black_glass/OboutDropDownList" Width="100px" ControlsToDisable="" ControlsToEnable="" DataSourceID="dsFiscalYear" 
        ...
        <tr>
            <td style="width:600px;vertical-align:top; text-align:left;">
                ...
                <td style="vertical-align:top; text-align:left; padding-top:5px;" >
                    <div style="height:205px; overflow-y:auto; border:solid 1px #000000;">
            ...
            <td style="vertical-align:top; text-align:left; padding-left:5px;">
                ...
                <asp:GridView ID="gvIncExpSummary" runat="server" AutoGenerateColumns="False" DataSourceID="dsIncExpSummary" Width="600" 
                    ...
                    <Columns>
                        <asp:BoundField DataField="Fund" HeaderText="Fund" ReadOnly="True" SortExpression="General Fund"></asp:BoundField>
    ...
    <asp:SqlDataSource ID="dsFundList" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' 
        SelectCommand="SELECT [FundId], [ShortDesc] FROM [t_acct_fund] WHERE ([IsSchoolFund] = 1) ORDER BY [SeqNum]">
    </asp:SqlDataSource>

    <asp:SqlDataSource ID="dsIncomeDepts" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' 
        SelectCommand="get_TBCA_IncomeDept_BudgetVSActual" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlFund" PropertyName="SelectedValue" Name="FundId" Type="Int32"></asp:ControlParameter>
            <asp:ControlParameter ControlID="ddlFiscalYear" PropertyName="SelectedValue" Name="FiscalYear" Type="Int32"></asp:ControlParameter>
        </SelectParameters>
    </asp:SqlDataSource>

    <asp:SqlDataSource ID="dsIncomeAccts" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' 
        SelectCommand="get_IncomeSubDept_BudgetVSActual" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlFiscalYear" PropertyName="SelectedValue" Name="FiscalYear" Type="Int32"></asp:ControlParameter>
    ...
    <asp:SqlDataSource ID="dsIncExpSummary" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="get_IncomeExpenseSummary_BudgetVSActual" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlFund" PropertyName="SelectedValue" Name="FundId" Type="Int32"></asp:ControlParameter>
            <asp:ControlParameter ControlID="ddlFiscalYear" PropertyName="SelectedValue" Name="FiscalYear" Type="Int32"></asp:ControlParameter>
        </SelectParameters>
