...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table style="width: 100%;" class="header-table">
        <tr class="header-row">
            <td>
                ...
                <cc1:OboutDropDownList ID="ddlEE" runat="server" DataSourceID="dsEEList2" DataTextField="DisplayName" DataValueField="UserID" AutoPostBack="True"  
                    FolderStyle="styles//dropdownlist/black_glass/OboutDropDownList" Width="200px" OnDataBound="ddlEE_DataBound"></cc1:OboutDropDownList>
                ...
                <cc1:OboutDropDownList ID="ddlWeeks" runat="server"  DataSourceID="dsWeeks" DataTextField="Year-Week" DataValueField="WeekID" 
                    AutoPostBack="True" Width="300px" Height="400px" OnDataBound="ddlWeeks_DataBound"></cc1:OboutDropDownList>    
        ...
        <tr>
            <td>
                <asp:GridView ID="gridVacBalances" runat="server" AutoGenerateColumns="False" DataSourceID="dsVacationBalances" 
                    CellPadding="4" ForeColor="#333333" GridLines="Both">
                    <AlternatingRowStyle BackColor="White" ForeColor="#284775"></AlternatingRowStyle>
                    <Columns>
                        <asp:BoundField DataField="BenefitDesc" HeaderText="Description" ReadOnly="True" ItemStyle-HorizontalAlign="Right"></asp:BoundField>
                        <asp:BoundField DataField="VacationHours" HeaderText="Vacation Time" ReadOnly="True" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:f1}"></asp:BoundField>
                        <asp:BoundField DataField="SickHours" HeaderText="Sick Time" ReadOnly="True" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:f1}"></asp:BoundField>
                    </Columns>
    ...
    <asp:SqlDataSource ID="dsEEList2" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' 
        SelectCommand="get_EEAuthList2" SelectCommandType="StoredProcedure">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="dsWeeks" runat="server" ConnectionString="<%$ ConnectionStrings:TBBF %>" 
        SelectCommand="SELECT TOP 106 [WeekID], ' ' + datename(m,[BegDate]) + '-' + datename(d,[BegDate]) + ' to ' + datename(m,[EndDate]) + '-' + datename(d,[EndDate]) + ' -- ' + datename(year,[BegDate]) + ' (' + cast([WeekNum] AS varchar(3)) + ')' AS [Year-Week], [begdate], [enddate] FROM [tblWeeks] WHERE [begdate] >= dateadd(year,-2,getdate())"></asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="dsVacationBalances" runat="server" ConnectionString='<%$ ConnectionStrings:TBBF %>' SelectCommand="get_EE_VacBalances" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlEE" PropertyName="SelectedValue" Name="UserID" Type="Int32"></asp:ControlParameter>
        </SelectParameters>
    </asp:SqlDataSource>
